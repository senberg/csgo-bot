...
public interface Psapi extends StdCallLibrary {
     ...
     * module.
     *
     * @param process    A handle to the process that contains the module.
     * @param module     A handle to the module. If this parameter is NULL,
     *                   GetModuleFileNameEx returns the path of the executable file of
     *                   the process specified in hProcess.
     * @param lpFilename A pointer to a buffer that receives the fully qualified path
     ...
     * @param lpcbNeeded The number of bytes required to store all module handles in
     *                   the lphModule array.
    ...
    boolean EnumProcessModulesEx(HANDLE hProcess, HMODULE[] lphModule, int cb, IntByReference lpcbNeeded, int flags);
     ...
     * To use run-time dynamic linking, load Psapi.dll.
     *
     * @param hProcess  A handle to the process that contains the module. The handle
     ...
     * @param lpmodinfo A pointer to the MODULEINFO structure that receives
     *                  information about the module.
     * @param cb        The size of the MODULEINFO structure, in bytes.
     * @return If the function succeeds, the return value is nonzero. If the
     * function fails, the return value is zero. To get extended error
     * information, call GetLastError.
     ...
     * @param lpImageFileName A pointer to a buffer that receives the full path to the
     *                        executable file.
     * @param nSize           The size of the lpImageFileName buffer, in characters.
     * @return If the function succeeds, the return value specifies the length
     * of the string copied to the buffer. If the function fails, the
     * return value is zero. To get extended error information, call
     * GetLastError.
     ...
     *
     * @param pPerformanceInformation A pointer to a {@link PERFORMANCE_INFORMATION} structure that
     *                                receives the performance information.
     * @param cb                      The size of the {@link PERFORMANCE_INFORMATION} structure, in
     *                                bytes.
    ...
    int GetModuleBaseName(HANDLE hProcess, HMODULE hmodule, char[] lpBaseName, int size);
