...
public interface User32 extends StdCallLibrary, WinUser, WinNT {
     ...
     *
     * @param lpClassName  Long pointer to a null-terminated string that specifies the
     ...
     * @param lpWindowName Long pointer to a null-terminated string that specifies the
     ...
     *                    window belongs.
     * @param lpClassName Long pointer to the buffer that is to receive the class name
     *                    string.
     * @param nMaxCount   Specifies the length, in characters, of the buffer pointed to
     ...
     * @param lpgui    Pointer to a GUITHREADINFO structure that receives information
     ...
     *
     * @param hWnd Handle to the window.
     * @param rect Long pointer to a RECT structure that structure that receives
     ...
     * @param nMaxCount Specifies the maximum number of characters to copy to the
     ...
     *
     * @param hWnd           Handle to the window whose module file name will be retrieved.
     * @param lpszFileName   Pointer to a buffer that receives the path and file name.
     * @param cchFileNameMax Specifies the maximum number of TCHARs that can be copied into
     ...
     *
     * @param lpEnumFunc Long pointer to an application-defined callback function.
     ...
     * function.
     *
     * @param dwThreadId Identifies the thread whose windows are to be enumerated.
     * @param lpEnumFunc Pointer to an application-defined callback function.
     * @param data       Specifies an application-defined value to be passed to the
     *                   callback function.
     ...
     *
     * @param hInstance Handle to an instance of the module whose executable file
     *                  contains the icon to be loaded. This parameter must be NULL
     *                  when a standard icon is being loaded.
     * @param iconName  Long pointer to a null-terminated string that contains the
     ...
     *
     * @param hinst    Handle to an instance of the module that contains the image to
     *                 be loaded.
     ...
     * @param xDesired Specifies the width, in pixels, of the icon or cursor. If this
     ...
     * @param yDesired Specifies the height, in pixels, of the icon or cursor. If
     ...
     * @param hWnd   Handle to the window and, indirectly, the class to which the
     *               window belongs.
     * @param nIndex Specifies the zero-based offset to the value to be retrieved.
     ...
     * @param pdwFlags Pointer to a DWORD that receives a layering flag. This can be
     ...
     * @param hdcDst  Handle to a device context (DC) for the screen. This handle is
     ...
     * @param psize   Pointer to a SIZE structure that specifies the new size of the
     ...
     *                should be NULL.
     * @param crKey   Pointer to a COLORREF value that specifies the color key to be
     ...
     * @param hRgn    Handle to a region. The function sets the window region of the
     *                window to this region. If hRgn is NULL, the function sets the
     *                window region to NULL.
     * @param bRedraw Specifies whether the system redraws the window after setting
     ...
     *
     * @param lpKeyState Pointer to the 256-byte array that receives the status data
     ...
     *                   the lpfn parameter.
     * @param dwThreadId Specifies the identifier of the thread with which the hook
     ...
     *
     * @param hhk    Ignored.
     * @param nCode  Specifies the hook code passed to the current hook procedure.
     ...
     * @param wMsgFilterMin Specifies the integer value of the lowest message value to be
     *                      retrieved.
     * @param wMsgFilterMax Specifies the integer value of the highest message value to be
     *                      retrieved.
     ...
     * @param wMsgFilterMin Specifies the value of the first message in the range of
     *                      messages to be examined.
     * @param wMsgFilterMax Specifies the value of the last message in the range of
     *                      messages to be examined.
     * @param wRemoveMsg    Specifies how messages are handled. This parameter can be one
     ...
     * message.
     *
     * @param nExitCode Specifies an application exit code. This value is used as the
     ...
     * @param hWndNewParent A handle to the new parent window. If this parameter is NULL,
     ...
     *
     * @param hWnd            A handle to the window.
     * @param hWndInsertAfter A handle to the window to precede the positioned window in the
     *                        Z order.
     ...
     *                   idAttach.
     * @param fAttach    If this parameter is TRUE, the two threads are attached. If
     ...
     *                       returns immediately.
     * @param dwMilliseconds The time-out interval, in milliseconds. If dwMilliseconds is
     ...
     *               the update region.
     * @param bErase Specifies whether the background within the update region is
     ...
     * @param lprcUpdate A pointer to a RECT structure containing the coordinates, in
     *                   device units, of the update rectangle. This parameter is
     *                   ignored if the hrgnUpdate parameter identifies a region.
     * @param hrgnUpdate A handle to the update region. If both the hrgnUpdate and
     ...
     * @param fsModifiers The keys that must be pressed in combination with the key
     ...
     *                    lpClassName; the high-order word must be zero.
     * @param hInstance   [in,optional] Type: HINSTANCE A handle to the instance of the
     ...
     *                           handle.
     * @param notificationFilter [in] A pointer to a block of data that specifies the type of
     ...
     *
     * @param hIcon     A handle to the icon or cursor.
     *                  <p>
     ...
     * @param piconinfo A pointer to an ICONINFO structure. The function fills in the
     *                  structure's members.
     ...
     *
     * @param hWnd       A handle to the window whose window procedure will receive the
     *                   message.
     *                   <p>
     ...
     * @param wParam     Any additional message-specific information.
     * @param lParam     Any additional message-specific information.
     * @param fuFlags    The behavior of this function. This parameter can be one or
     *                   more of the following values: {@link WinUser#SMTO_ABORTIFHUNG}
     *                   etc.
     * @param uTimeout   The duration of the time-out period, in milliseconds. If the
     ...
     *                   delay.
     * @param lpdwResult The result of the message processing. The value of this
     ...
     *
     * @param hWnd   A handle to the window and, indirectly, the class to which the
     *               window belongs.
     * @param nIndex The value to be retrieved. To retrieve a value from the extra
    ...
    /**
     * @param pRawInputDeviceList An array of {@link WinUser.RAWINPUTDEVICELIST} structures for the devices
     *                            attached to the system. If (@code null}, the number of devices is
     *                            returned in <tt>puiNumDevices</tt>
     * @param puiNumDevices       If <tt>pRawInputDeviceList</tt> is {@code null}, the function populates
     ...
     * @param cbSize              The size of a {@link WinUser.RAWINPUTDEVICELIST} structure, in bytes.
     ...
     *
     * @param hWnd  A handle to the window that will be copied.
     * @param dest  A handle to the destination device context.
     * @param flags The drawing options. It can be one of the following values:
     *              <br>
     *              PW_CLIENTONLY:<br>
    ...
    /**
     * @param parent    Type: <strong>HWND</strong><br>
     ...
     * @param child     Type: <strong>HWND</strong><br>
     ...
     * @param className Type: <strong>LPCTSTR</strong><br>
     ...
     * @param window    Type: <strong>LPCTSTR</strong><br>
     ...
     *
     * @param hwnd    A handle to the window whose ancestor is to be retrieved. If
     *                this parameter is the desktop window, the function returns
     *                NULL.
     * @param gaFlags The ancestor to be retrieved. This parameter can be one of the
     *                following values:<br>
     *                <ul>
     ...
     *                         possible event value.
     * @param hmodWinEventProc Type: HMODULE<br>
     ...
     * SetWinEventHook.
     *
     * @param hook Type: HWINEVENTHOOK<br>
     ...
     *
     * @param hIcon A handle to the icon to be copied.
     * @return If the function succeeds, the return value is a handle to the
     * duplicate icon. <br>
     * If the function fails, the return value is NULL. To get extended
     * error information, call GetLastError.
